...
vid  = cv2.VideoWriter('part2.avi', cv2.VideoWriter_fourcc(*'XVID'),10,(1224,370))

frame = cv2.imread("input/data1/0000000000.png")
gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
new_image = adaptive_hist_eq(gray)
vid.write(new_image)
...
new_image = adaptive_hist_eq(gray)
vid.write(new_image)
cv2.imshow('Adaptive Histogram Equalization', new_image)
cv2.waitKey()
cv2.destroyAllWindows()
#cv2.imwrite('part2.jpg', new_image)
